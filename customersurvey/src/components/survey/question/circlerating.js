...
const CircleRating = () => {
    ...
    return (
      <div >
        <label style={{display:"inline-block"}}><input type="radio" value={1} name="rating" style={{height:"20px", width:"20px",display:"block"}}/>1</label>
        ...
        <label style={{display:"inline-block",marginLeft:"5%"}}><input type="radio" value={5} name="rating" style={{height:"20px", width:"20px",display:"block"}}/>5</label>
      </div>
    );
  };
