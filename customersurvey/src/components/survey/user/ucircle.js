...
export default class UCircleRating extends React.Component {
  ...
  render(){
    return <div >
    <label style={{display:"inline-block",textAlign:"center"}}><input type="radio" value={1} name={this.props.name} onClick={(e)=>this.getvalue(e)} style={{height:"20px", width:"20px",display:"block"}}/>1</label>
    ...
    <label style={{display:"inline-block",marginLeft:"5%",textAlign:"center"}}><input type="radio" value={5} onClick={(e)=>this.getvalue(e)} name={this.props.name} style={{height:"20px", width:"20px",display:"block"}}/>5</label>
  </div>
  }
}
